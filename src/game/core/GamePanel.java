...
public class GamePanel extends Room {
  ...
  public void setup(){
    ...
    JLabel label = new JLabel("ESCAPE GAME");
    
    // setup
    quit.setFont(new Font("Monospace", Font.BOLD, 40));
    start.setFont(new Font("Monospace", Font.BOLD, 40));
    ...
    // action
    start.listen($ -> this.next("room1"));
    
    // placement
    start.setBounds(660, 298, 278 ,61);
    quit.setBounds(660, 401, 278 ,61);
    label.setBounds(getWidth() / 2 - 200, 175, 800, 63);
